...
//网络请求
function request(parameters = "", success, method, data, header) {
  wx.request({
    url: config.BaseURL + parameters,
    data: data ? data : {},
    method: method ? method : 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
...
//loading提示
function showLoading(title = "加载数据中...", duration = 5000) {
  wx.showToast({
    title: title,
    mask: true,
    icon: 'loading',
